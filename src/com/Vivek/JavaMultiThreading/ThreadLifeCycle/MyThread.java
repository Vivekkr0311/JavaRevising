package com.Vivek.JavaMultiThreading.ThreadLifeCycle;
...
public class MyThread extends Thread{
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        // Main class thread state, we get RUNNABLE, means RUNNABLE also represents running thread
        ...
        // Main thread was waiting for t1 to complete its task,
